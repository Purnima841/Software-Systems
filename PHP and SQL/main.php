...
<?php
	...
	if($result){
		...
		$result=mysqli_query($conn,$query);
		$query = "Create table authors(author varchar(120) ,publisher varchar(30))";				
		$result=mysqli_query($conn,$query); 
		$query = "Create table titles(title varchar(120) ,author varchar(120),year smallint(6))";				
		$result=mysqli_query($conn,$query); 
	}
...
<body>
    <form action="next.php" method="post"> 
    	Display table Authors : <input type="submit" name = "ALL" value="click!" > <br><br>
    	Add an author : <br>
